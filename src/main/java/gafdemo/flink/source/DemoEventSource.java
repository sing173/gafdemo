...
public class DemoEventSource extends RichParallelSourceFunction<DataSourceEvent> {
    ...
    public void run(SourceContext<DataSourceEvent> sourceContext) throws Exception {
        while (running) {
            ...
            dataSourceEvent.setCardNo(cardNo+"");
            ...
            System.out.println("build event -- seqNo:"+dataSourceEvent.getSeqNo()+",cardNo:"+dataSourceEvent.getCardNo()+",trade:"+dataMap.get("trade")+",time:"+dataSourceEvent.getEventTime());
